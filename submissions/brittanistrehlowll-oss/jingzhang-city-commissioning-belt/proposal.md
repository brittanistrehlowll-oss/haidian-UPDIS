...
![图3｜典型场景素材与城市测试界面：从能力来源到本地测试接口](assets/media/regional-coordination-03-scenarios.png)

**规划判断｜**图3把区域协同从“区位关系”推进到“场景界面”，将社区生活、科研模型、科学智能、智能制造、铁路遗产公共空间和区域算力转译为六类可被城市设计承接的场景来源。图内影像用于表达空间类型、活动氛围和界面关系，属于 **典型场景示意 / Representative Scenario Imagery**。

**空间承接｜**场景分别映射至 AI原点社区的生活服务界面、众智园的科研原型与工具验证界面、大钟寺的科学智能与仿真界面、中关村科技服务翼的工程化与中试界面、小月河场景赋能翼的城市生活与产业活动界面，以及京津冀区域支撑界面。

**输入—承接—输出 / 反馈｜**输入以需求、模型、数据、设备、遗产空间和区域支撑呈现；承接以公共空间、建筑首层、街道、社区和更新单元呈现；输出形成场景验证、公共服务改进、工程化接口、活动运营记录和规划规则更新。
