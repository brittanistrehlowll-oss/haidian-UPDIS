...
本节是对现有五张核心规划证据图的增补，不替换或改写核心证据图、GeoJSON、指标矩阵、图纸和既有项目要求。三张方案图专门表达建筑母体、公共界面、材料、结构意向和空间体验；正式边界、面积、交通、开发强度和工程参数仍以结构化资料和正式复核为准。

### 方案一｜建筑母体与公共脊

![方案一：白色开放建筑、红砖城市建筑、公共连廊与三色联调舱](assets/media/architecture-overview.webp)

这一方案把京张公共脊两侧的建筑组织为两种互补的城市母体：白色开放建筑采用规则体量、通透首层和水平长窗，表达开放试验、协作和可变工作空间；红砖城市建筑以较重的实体感、深窗和垂直构件承接城市记忆、长期性和公共制度。跨线公共连廊把两者连接为连续的公共界面，三个色彩节点则提示“技术可用—公共可用—规则可用”的能力转化链。

这张图同时给出总立面、剖面、平面、轴测、材料接口和圆形联调舱的关系，帮助阅读建筑系统如何落到公共脊两侧。图中的建筑位置、层数、跨度和节点尺寸均为概念表达，不是法定控制指标或施工图。

### 方案二｜三节点、结构与材料表达

![方案二：三节点总图、城市剖面、结构概念、连廊细部与材料氛围](assets/media/architecture-technical-board.webp)

这一方案以“总图—城市剖面—功能图解—结构概念—连廊细部—材料—日夜状态”的顺序说明空间如何承载 Civic AI Overlay。黄色节点偏向技术测试与可替换接口，蓝色节点偏向公共服务、解释告知和人工转接，红色节点偏向规则公开、版本状态和复验入口。三者是可迭代的城市联调舱，而不是三个大型主体建筑。

白色石材或浅色预制混凝土向砖石界面过渡，连廊因此被定义为 **Civic Handover Bridge｜城市能力交接廊**：技术空间经过公共服务界面，逐步进入城市规则空间。结构图和材料图用于解释设计意向，不对结构安全、构造做法、耐久年限或工程可行性作结论。

### 方案三｜空间序列与公共界面

![方案三：京张公共脊、三重点区、昼夜场景与空间体验序列](assets/media/architecture-spatial-sequence.webp)

这一方案把三处重点区组织为一条连续的空间体验：众智园提供可复现的技术测试和设备替换界面，AI原点提供面向居民的公共服务、解释和人工帮助，大钟寺提供证据公开、规则复验和更新协商界面。主轴、广场、首层、连廊和联调舱共同构成可步行的公共脊；日景和夜景表达的是使用氛围与运营时段差异，不是照明、客流或运营容量承诺。

方案三中的建筑、铁路空间、绿化和人群共同形成“从技术接口到公共生活再到制度化更新”的连续叙事。它补充的是空间感受和建筑—城市关系，不替代五张核心证据图，也不改变当前 `provisional_rough` 几何和正式指标口径。

### 建筑设计说明与控制边界

1. **建筑首先是正常城市建筑，其次才承载 AI 能力。** 即使模型升级、网络故障或居民选择不使用 AI，基础交通、公共大厅、无障碍、消防疏散和人工服务仍应独立成立。
2. **AI 采用可维护的附加层。** 感知、计算、能源和交互界面集中在可替换的接口空间、设备带和联调舱中，与主体建筑的结构寿命分离；联调舱保持小型基础设施和公共节点尺度。
3. **连廊是公共能力交接界面。** 后续深化必须核对两端真实楼层、无障碍流线、结构支撑、净高、消防和铁路/道路条件；当前图件不证明这些工程条件已经成立。
4. **尺度只表达设计意向。** 建筑以 3–6 层中低层公共建筑为主要视觉尺度，避免压倒铁路公共脊；实际高度、面积、退线、跨度、权属、文保和结构条件均保持待正式资料复核。
5. **公共利益路径不被视觉方案取消。** 任何建筑节点仍需保留 AI、人工、离线和低/无感知四条等价路径，并允许暂停、降级、回滚和退出。
